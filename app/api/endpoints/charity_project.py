...
from app.schemas.charity_project import (
    CharityProjectList, CharityProjectCreate,
...
@router.delete(
    '/{project_id}', response_model=CharityProjectList,
...
async def update_project(project_id: int, obj_in: CharityProjectUpdate, session: AsyncSession = Depends(get_async_session)):
    instance = await check_charity_project_exist(project_id, session)
